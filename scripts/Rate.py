...
# Get the directory where Rate.py is located (scripts/)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
# Go up one level (root), then into raw_data
CSV_PATH = os.path.join(BASE_DIR, '..', 'raw_data', 'movies_metadata.csv')
...
try:
    ...
    print(f"WARNING: '{CSV_PATH}' not found. Using fallback values.")
